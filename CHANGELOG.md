...
* 🔖 Release version 0.1.6. PR [#141](https://github.com/fastapi/fastapi-vscode/pull/141) by [@savannahostrowski](https://github.com/savannahostrowski).
...
* 📈 Only fire entrypoint detected on initial activation. PR [#122](https://github.com/fastapi/fastapi-vscode/pull/122) by [@savannahostrowski](https://github.com/savannahostrowski).
...
* 🔖 Release version 0.1.1. PR [#96](https://github.com/fastapi/fastapi-vscode/pull/96) by [@savannahostrowski](https://github.com/savannahostrowski).
...
* ⚙️  Add metadata and CI step for OpenVSX publishing. PR [#84](https://github.com/fastapi/fastapi-vscode/pull/84) by [@savannahostrowski](https://github.com/savannahostrowski).
* ⚙️  Remove 'Extension' from display name. PR [#92](https://github.com/fastapi/fastapi-vscode/pull/92) by [@savannahostrowski](https://github.com/savannahostrowski).
